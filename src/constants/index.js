...
export const workExperiences = [
  ...
  },
  {
    id: 2,
    name: 'Playdex',
    title: "A web3 gaming NFT rental marketplace supercharging social web3 gaming communities",
  ...
  },
  {
    id: 3,
    name: 'Art Pilgrim',
    title: "A virtual Art gallery bringing expressive art pieces closer to you",
    icon: 'https://framerusercontent.com/images/cli2a4JNDK7KK6xTd6suQHw29RI.png',
    link: 'https://responsible-site-094103.framer.app/',
  },
  {
    id: 4,
    name: 'Root And Grounds',
    title: "A one-stop-shop freshly roasted single-origin coffee beans and healthy products",
    icon: 'https://rootandgrounds.co/_next/static/media/redlogo.24765268.svg',
    link: 'https://rootandgrounds.co//',
  },
  {
    id: 5,
    name: 'VeriFi',
    title: "A Decentralized Ecosystem for streamlining digital assets",
    icon: 'https://verifi-dapp.vercel.app/favicon.ico',
    link: 'https://verifi-dapp.vercel.app/',
  },
  {
    id: 6,
    name: 'Premio',
    title: "A hypercasual gaming e-sports gaming app -  play and win prizes!",
    icon: 'https://framerusercontent.com/images/PLmwqdKjBNYtZan6Sk7urHTODJ8.png',
